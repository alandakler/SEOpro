...
Plugin URI: https://muzharovsky.com/seoplugin
Description: SEO плагин для WordPress: добавляет мета-теги и интегрируется с Вебмастером от Яндекс (Иконка ИКС + Яндекс Метрика).
Version: 1.0
...
add_action('admin_menu', function () {
    add_menu_page(
        'SEOplugin',           // Заголовок страницы
        'SEOplugin',           // Текст в меню
        'manage_options',       // Права доступа
        'seo-plugin',           // Ярлык (slug)
        'my_seo_plugin_settings_page',            // Функция содержимого
        plugins_url('img/ico.png', __FILE__), // Путь к файлу изображения
        6                               // Позиция
    );
});
